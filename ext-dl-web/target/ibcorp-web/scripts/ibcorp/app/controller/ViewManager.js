Ext.define('ibcorp.controller.ViewManager', {
    extend: 'Ext.app.Controller',
    requires: ['Ext.History'],
    views: ['ibcorp.view.UnsupportedBrowsers'],
    ...
    setView: function (requestedView) {
        ...
        Ext.getBody().removeCls(ibcorp.viewManager.recentView);
        ibcorp.viewManager.recentView = requestedView;
    ...
    init: function () {
        ...
        ibcorp.viewManager = this;

        ibcorp.viewManager.recentView = '';
