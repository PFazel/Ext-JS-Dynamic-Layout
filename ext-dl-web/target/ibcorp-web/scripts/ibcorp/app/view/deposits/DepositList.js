Ext.define("ibcorp.view.deposits.DepositList", {
            ...
            groupHeaderTpl: ['{[this.formatType(values.name)]}',
                {
                    formatType: function (name) {
                        return ibcorp.getText('DEPOSIT_GROUP_TYPE.'+name);
                    }
                }
            ]
        })
    ...
    initComponent: function () {
        this.columns = [
            { dataIndex: 'depositNumber', text: ibcorp.getText('DEPOSIT_LIST.DEPOSIT_NUMBER')},
            { dataIndex: 'balance', text: ibcorp.getText('DEPOSIT_LIST.BALANCE')},
            { dataIndex: 'availableBalance', text: ibcorp.getText('DEPOSIT_LIST.AVAILABLE_BALANCE')},
            { dataIndex: 'blockedAmount', text: ibcorp.getText('DEPOSIT_LIST.BLOCKED_AMOUNT')}
