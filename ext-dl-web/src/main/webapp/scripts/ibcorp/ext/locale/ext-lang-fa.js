...
Ext.onReady(function() {
    ...
    Ext.define("Ext.locale.fa.form.CheckboxGroup", {
        ...
        blankText: 'شما باید حداقل یک مورد را انتخاب کنید'
    });
    ...
    Ext.define("Ext.locale.fa.grid.plugin.RowEditing", {
    ...
    Ext.define("Ext.locale.fa.grid.header.Container", {
        ...
        columnsText: "ستون ها",
        groupByText: 'با این ستون گروه بندی کن',
        showGroupsText: 'نمایش به صورت گروه بندی شده'
    });

    Ext.define("Ext.locale.fa.grid.header.Grouping", {
